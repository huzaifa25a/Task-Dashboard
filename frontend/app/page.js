...
export default function LoginPage() {
  ...
  return (
    <div className={`fixed inset-0 backdrop-blur-md z-40 w-full h-full bg-linear-to-r from-[#3F5EFB] to-[#FC466B]`}>
        <div className="fixed z-50 inset-0 flex items-center justify-center">
            <div className="bg-[#ffffff15] flex flex-col justify-between items-center gap-5 rounded-lg border-2 border-white p-10 shadow-2xl">
                <h2 className="text-white mb-5">{showRegister ? 'REGISTER' : 'LOGIN'}</h2>
                ...
                <div className="flex flex-col items-center gap-2">
                    <p className="text-white"> {showRegister ? 'Already have an account?' : 'Do not have an account?'}</p>
                    <button
