        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-start gap-2">
            <button
              ...
              className="bg-green-700 hover:bg-green-800 w-30 cursor-pointer flex items-center justify-center gap-2 border-gray-200 border rounded-md p-1"
            >
            ...
            <div className="flex flex-col gap-4 items-center justify-center">
              {Tasks.map((task, index) => (
                <div>
                  <div
                    key={index}
                    className={`bg-[#ffffff15] hover:bg-[#ffffff3f] w-full min-w-xl max-w-4xl flex justify-between p-4 border-2 border-gray-200 rounded-md gap-5 ${showDeleteMessage === task._id ? 'rounded-none rounded-t-md ' : ''}`}
                  >
                    ...
                    <div className="flex flex-col justify-between items-end">
                      {showEditOption === task._id ? (
                        ...
                        <select
                          ...
                          value={task.status}
                          onChange={(e) => statusHandler(e.target.value, task._id)}
                        >
                          <option 
                      ...
                      <div className="flex flex-row gap-3">
                        ...
                        <button
                          className="cursor-pointer"
                          onClick={() => {setShowEditOption(''), setShowDeleteMessage(task._id)}}
                        >
